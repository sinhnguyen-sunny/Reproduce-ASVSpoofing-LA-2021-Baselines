...
if __name__ == '__main__':
	...
	if args.eval:
		...
		file_eval = genSpoof_list( dir_meta =  '/media/SSD/sinhnta/ASVspoof2021_LA_eval/ASVspoof2021.LA.cm.eval.trl.txt',is_train=False,is_eval=True)
		...
		eval_set=Dataset_ASVspoof2021_eval(list_IDs = file_eval,base_dir = '/media/SSD/sinhnta/ASVspoof2021_LA_eval/')
	...
	d_label_trn,file_train = genSpoof_list( dir_meta =  '/media/SSD/sinhnta/LA_ASVspoof2019_dataset/LA/LA/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.train.trn.txt',is_train=True,is_eval=False)
	...
	train_set=Dataset_ASVspoof2019_train(list_IDs = file_train,labels = d_label_trn,base_dir = "/media/SSD/sinhnta/LA_ASVspoof2019_dataset/LA/LA/ASVspoof2019_LA_train/")
	...
	d_label_dev,file_dev = genSpoof_list( dir_meta =  "/media/SSD/sinhnta/LA_ASVspoof2019_dataset/LA/LA/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.dev.trl.txt",is_train=False,is_eval=False)
	...
	dev_set = Dataset_ASVspoof2019_train(list_IDs = file_dev,
		labels = d_label_dev,
		base_dir = "/media/SSD/sinhnta/LA_ASVspoof2019_dataset/LA/LA/ASVspoof2019_LA_dev/")
