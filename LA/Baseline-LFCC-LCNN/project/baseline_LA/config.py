...
tmp = "/home/sinhnta/ASV/Dataset/LA/LA"
...
trn_list = "/home/sinhnta/ASV/Dataset/LA/LA/ASVspoof2019_LA_train/list_file.lst"
# val_file_list: list of files for validation set. It can be None
# val_list = tmp + '/scp/val.lst'
val_list = "/home/sinhnta/ASV/Dataset/LA/LA/ASVspoof2019_LA_dev/list_file.lst"
...
optional_argument = ['/home/sinhnta/ASV/Dataset/LA/LA/protocol.txt']
...
test_list = '/home/sinhnta/ASV/Dataset/ASVspoof2021_LA_eval/list_file.lst'

# Directories for input features
# input_dirs = [path_of_feature_1, path_of_feature_2, ..., ]
# directory of the evaluation set waveform
# test_input_dirs = [tmp + '/eval']
test_input_dirs = ['/home/sinhnta/ASV/Dataset/ASVspoof2021_LA_eval/flac']
